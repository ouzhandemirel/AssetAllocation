...
public class SecondEmailFanoutConsumerService : BackgroundService
{
    private readonly IModel _channel;
    private readonly IConnection _connection;
    private const string ExchangeName = ExchangeNames.EmailExhange;
    private const string QueueName = "second_email_queue";
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public SecondEmailFanoutConsumerService(IConnection connection, IServiceScopeFactory serviceScopeFactory)
    {
